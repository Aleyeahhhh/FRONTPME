...
const ClientsData = () => {
    ...
    // Appel à l'API pour obtenir les données clients
    axios.get('/client/get_client') 
    .then(response => {
        
        setData(response.data.clients); // Mettez à jour l'état local avec les données de l'API
    })
    .catch(error => {
