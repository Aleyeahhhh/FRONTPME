...
import CustomerList from './CustomerList'; // Importez votre composant CustomerList
...
function AddCustomerForm({ setIsAddFormVisible }) {
    ...
    const toggleAddForm = () => {
        ...
        // Après la soumission, masquez le formulaire
        //setIsAddFormVisible(false);
    };

    return (
        <Grid container spacing={gridSpacing} style={{overflowY:"scroll"}}>
            <Grid item xs={12}>
                <MainCard content={false} sx={{ overflow: 'scroll' }}>
                    <CardActions
                        sx={{
                            position: 'sticky',
                                        ...
                                        <CardActions>
                                            <Grid container spacing={2} alignItems="center">
                                                <Grid item xs={12} sm={6}>
                                                    <Button variant="contained" color="secondary" onClick={toggleAddForm}>
                                                        {showAddForm ? 'Back to List' : 'Add Customer'}
                                                    </Button>
                                                </Grid>
                                            </Grid>
                                        </CardActions>
